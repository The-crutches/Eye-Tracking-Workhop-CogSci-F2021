...
foraging_fixations <- read_csv("~/Uni stuff/Computational Modeling/Eye-Tracking-Workhop-CogSci-F2021/data/foraging_fixations.csv")
soceng_fixations <- read_csv("~/Uni stuff/Computational Modeling/Eye-Tracking-Workhop-CogSci-F2021/data/soceng_fixations.csv")
## Load saccades data for both experiments
foraging_saccades <- read_csv("~/Uni stuff/Computational Modeling/Eye-Tracking-Workhop-CogSci-F2021/data/foraging_saccades.csv")
soceng_saccades <- read_csv("~/Uni stuff/Computational Modeling/Eye-Tracking-Workhop-CogSci-F2021/data/soceng_saccades.csv")
...
```{r}
range(Fixations$PositionX, na.rm = T)
range(Fixations$PositionY, na.rm = T)

range(Saccades$StartX, na.rm = T)
range(Saccades$StartY, na.rm = T)
...
```{r}
Fixations <- Fixations %>% 
  filter(PositionX >0 & PositionX<1680, PositionY > 0 & PositionY < 1050) 


  ...

Saccades <- Saccades %>% 
  filter(StartX >0 & StartX<1680, StartY > 0 & StartY < 1050, EndX > 0 & EndX < 1680, EndY >0 & EndY < 1050)
...
range(Saccades$EndX, na.rm = T)
range(Saccades$EndY, na.rm = T)
...
img <- jpeg::readJPEG('C:/Users/julie/OneDrive/Dokumenter/Uni stuff/Computational Modeling/Eye-Tracking-Workhop-CogSci-F2021/data/stimuli_Foraging/space_capsules.jpg')  
...
The fixations do not match the picture very well. Let's fix this problem by flipping the y-axis back. To do this, we just take the maximum y-axis coordinate *+1* (we do not have to)minus the coordinate:
